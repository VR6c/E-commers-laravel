...
@section('title', 'Add New Customer — Admin')
...
<x-admin.page-header
    ...
    :subtitle="'Register a new customer account manually'"
    :breadcrumbs="['Customers' => route('admin.customers.index'), 'Create' => '']">
    <x-slot:actions>
            ...
            <x-admin.form-card :title="'Account Status'" :icon="'bi bi-toggle2-on'">
                ...
                <div class="d-grid gap-2 pt-2">
                    <button type="submit" class="btn btn-primary shadow-sm">
                        <i class="bi bi-person-check-fill me-1"></i> {{ 'Save Customer' }}
                    </button>
