...
@section('title', 'Edit Currency — Admin')

@section('content')

<x-admin.page-header
    :title="'Edit Currency'"
    :breadcrumbs="['Currencies' => route('admin.currencies.index'), 'Edit #' . $currency->id => '']">
    <x-slot:actions>
            ...
            <x-admin.form-card :title="'Update & Action'" :icon="'bi bi-check-circle'">
                <div class="p-3 bg-light rounded mb-4" style="border: 1px solid var(--border-subtle);">
                    <div class="d-flex align-items-start gap-2">
                        ...
                        <p class="text-muted small mb-0">
                            Updating exchange rates recalculates storefront price conversions for visitors viewing this currency.
                        </p>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary shadow-sm py-2-5">
                        <i class="bi bi-check-circle-fill me-1"></i> {{ 'Update Currency' }}
                    </button>
